...
def rnd_positions(reels, rnd):
    ...
    #print "Reel 1", len(reels[0]), reel1_pos, reel1_rem
    #print "Reel 2", len(reels[1]), reel2_pos, reel2_rem
    #print "Reel 3", len(reels[2]), reel3_pos, reel3_rem
    #print "Reel 4", len(reels[3]), reel4_pos, reel4_rem
    #print "Reel 5", len(reels[4]), reel5_pos, reel5_rem
